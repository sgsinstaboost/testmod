...

{
  ...
  description: "Caste Certificate apply karne ke liye niche details bharein, documents upload karein aur application fee pay karein.",
  tags: [
  ...
  fields: [
    ...
    },
    {
      ...
      name: "id_document",
      label: "पहचान प्रमाण पत्र दोनों साइड अपलोड करें / Upload both sides of ID proof document.",
      type: "file",
      accept: "image/*, application/pdf",
      required: true
    },
...

{
  ...
  price: 90,
  category: "Certificates (Jati/Aaya/Niwas)",
  description: "जाति, आय एवं निवास प्रमाण पत्र एक साथ आवेदन करने के लिए नीचे अपनी पूरी डिटेल्स भरें, सभी आवश्यक दस्तावेज़ अपलोड करें और भुगतान करें।",
...

{
  ...
  description: "Character Certificate online apply karne ke liye niche details bharein, documents upload karein aur application fee pay karein.",
  tags: [
...

{
  ...
  fields: [
    ...
    { id: "field_father_name", name: "father_name", label: "Father Name / पिता का नाम", type: "text", required: true, placeholder: "Father name likhein" },
    { id: "field_mother_name", name: "mother_name", label: "Mother Name / माता का नाम", type: "text", required: true, placeholder: "Mother name likhein" },
    { id: "field_mobile_no", name: "mobile_no", label: "Mobile Number (जो आपके पहचान पत्र से लिंक हो) / मोबाइल नंबर", type: "tel", required: true, placeholder: "Linked mobile number" },
    {
      id: "field_applicant_photo",
      name: "applicant_photo",
      label: "Upload Photo / फोटो अपलोड करें",
